...
Tickets.prototype.createMany = function (tickets, cb) {
  this.request('POST', ['tickets', 'create_many'], tickets,  cb);
};
...
Tickets.prototype.addCollaborators = function (ticketID, collaborators, cb) {
  this.requestAll('PUT', ['tickets', ticketID, 'additional_collaborators'], collaborators,  cb);//all?
};
